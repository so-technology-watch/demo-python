...
class AssurancePersistence:
    def __init__(self, assurance):
        self.dao = dao_commons.GenericDao(assurance)
...
def build_select_req(entity):
    ...
    req = "select * from assurance where assurance_id = ?"
    return req, params
...
def build_insert_req(entity):
    ...
    req = "insert into assurance ( assurance_id, car_id, type, montant, date_debut, date_fin ) values (?,?,?,?,?,?)"
    return req, params
...
def buil_update_req(entity):
    ...
    req = "update Assurance set assurance_id=?, car_id=?, type=?, montant=?, date_debut=?, date_fin=? where assurance_id = ?"
    return req, params
...
def build_delete_req(entity):
    ...
    ins_dict, i = vars(entity), ''
    params = [i for i in ins_dict.values() if i is not None]
    req = "delete from assurance where assurance_id = ?"
    return req, params
...
def new_instance_with_primary_key(_id):
    ...
    """
    return Assurance(_id, None, None, None, None, None)
