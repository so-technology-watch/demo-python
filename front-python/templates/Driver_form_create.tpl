    ...
    <div class="container">
        <div class="panel-group">
            <div class="panel panel-info">
                <div class="panel-heading"><h3><span class="glyphicon glyphicon-leaf"></span> Create Driver </h3></div>
                <div class="panel-body">
					<form class="form-horizontal" method="post" action="/Driver/create" id="driver_form">
						<a href="../../../Driver">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select id='person_id' name='person_id' class="selectpicker" data-live-search="true">
                                    % for Person in list :
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select id='car_id' name='car_id' class="selectpicker" data-live-search="true">
                                    % for Car in list2 :
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control" id="licence_number" name="licence_number" value=""/>
							</div>
						</div>
						<div class="form-group">
							<label for="licence_date" class="col-sm-2">licence_date</label>
							<div class="col-sm-8">
								<input class="form-control" type='date' id="licence_date" name="licence_date" value=""/>
							</div>
						</div>
					</form>
				</div>
