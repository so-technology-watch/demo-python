...
from services import Workgroup_service as commons_entity_service
from jsonSerializer.WorkgroupJsonSerializer import WorkgroupJsonSerializer
from entities.Workgroup import Workgroup
import json

workgroup_service = commons_entity_service.WorkgroupService("Workgroup")
