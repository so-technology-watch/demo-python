# Python class for service of Badge 
...
class BadgeService:
    def __init__(self):
        self.dao = dao_commons.GenericDao(Badge)

    def find_by_id(self, badgeNumber):
        """
        Tries to find an entity using its Id / Primary Key
        :param badgeNumber: PK of the entity to find
        :return: False if entity not found, entity if found
        """
        request = build_query(badgeNumber)
    ...
    def insert(self, entity):
        ...
        """
        request = build_query(entity.badgeNumber)
    ...
    def delete_by_id(self, badgeNumber):
        """
    ...
    def exists_by_id(self, badgeNumber):
        """
...
def build_query(badgeNumber):
    return text("Badge.badgeNumber == '{}'".format(badgeNumber))
