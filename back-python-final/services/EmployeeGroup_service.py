# Python class for service of EmployeeGroup 
...
class EmployeeGroupService:
    def __init__(self):
        self.dao = dao_commons.GenericDao(EmployeeGroup)

    def find_by_id(self, employeeCode, groupId):
        """
        Tries to find an entity using its Id / Primary Key
        :param employeeCode, groupId: PK of the entity to find
        :return: False if entity not found, entity if found
        """
        request = build_query(employeeCode, groupId)
    ...
    def insert(self, entity):
        ...
        """
        request = build_query(entity.employeeCode, entity.groupId)
    ...
    def delete_by_id(self, employeeCode, groupId):
        """
        Deletes an entity using its Id / Primary Key
        :param employeeCode, groupId: PK of the entity to delete
    ...
    def exists_by_id(self, employeeCode, groupId):
        """
        Ckeck if an Id / Primary Key is in the entity table
        :param employeeCode, groupId: PK to check in database
...
def build_query(employeeCode, groupId):
    return text("EmployeeGroup.employeeCode == '{}' and EmployeeGroup.groupId == '{}'".format(employeeCode, groupId))
