# Python class for service of BookOrderItem 
...
class BookOrderItemService:
    def __init__(self):
        self.dao = dao_commons.GenericDao(BookOrderItem)

    def find_by_id(self, bookOrderId, bookId):
        """
        Tries to find an entity using its Id / Primary Key
        :param bookOrderId, bookId: PK of the entity to find
    ...
    def delete_by_id(self, bookOrderId, bookId):
        ...
        :param bookOrderId, bookId: PK of the entity to delete
    ...
    def exists_by_id(self, bookOrderId, bookId):
        ...
        :param bookOrderId, bookId: PK to check in database
...
def build_query(bookOrderId, bookId):
    return text("BookOrderItem.bookOrderId == '{}' and BookOrderItem.bookId == '{}'".format(bookOrderId, bookId))
