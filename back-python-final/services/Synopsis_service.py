# Python class for service of Synopsis 
...
class SynopsisService:
    def __init__(self):
        self.dao = dao_commons.GenericDao(Synopsis)

    def find_by_id(self, bookId):
        """
        Tries to find an entity using its Id / Primary Key
        :param bookId: PK of the entity to find
        :return: False if entity not found, entity if found
        """
        request = build_query(bookId)
    ...
    def insert(self, entity):
        ...
        """
        request = build_query(entity.bookId)
    ...
    def delete_by_id(self, bookId):
        """
        Deletes an entity using its Id / Primary Key
        :param bookId: PK of the entity to delete
    ...
    def exists_by_id(self, bookId):
        """
        Ckeck if an Id / Primary Key is in the entity table
        :param bookId: PK to check in database
...
def build_query(bookId):
    return text("Synopsis.bookId == '{}'".format(bookId))
