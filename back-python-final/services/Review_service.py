# Python class for service of Review 
...
class ReviewService:
    def __init__(self):
        self.dao = dao_commons.GenericDao(Review)

    def find_by_id(self, customerCode, bookId):
        """
        Tries to find an entity using its Id / Primary Key
        :param customerCode, bookId: PK of the entity to find
        :return: False if entity not found, entity if found
        """
        request = build_query(customerCode, bookId)
    ...
    def insert(self, entity):
        ...
        """
        request = build_query(entity.customerCode, entity.bookId)
    ...
    def delete_by_id(self, customerCode, bookId):
        """
        Deletes an entity using its Id / Primary Key
        :param customerCode, bookId: PK of the entity to delete
    ...
    def exists_by_id(self, customerCode, bookId):
        """
        Ckeck if an Id / Primary Key is in the entity table
        :param customerCode, bookId: PK to check in database
...
def build_query(customerCode, bookId):
    return text("Review.customerCode == '{}' and Review.bookId == '{}'".format(customerCode, bookId))
