...
class TypesexeService:
    def __init__(self, entity):
        self.dao = dao_commons.GenericDao(entity, Typesexe)

    def find_by_id(self, idSexe):
        """
        Tries to find an entity using its Id / Primary Key
        :param _id:
        :return: entity
        """
        request = build_query(idSexe)
    ...
    def insert(self, entity):
        ...
        :return: entity
        """
        request = build_query(entity.idSexe)
        query = sqlalchemy_query(request)
...
def build_query(idSexe):
    return {
        "id_1": Typesexe.idSexe == '{}'.format(idSexe),
    }
